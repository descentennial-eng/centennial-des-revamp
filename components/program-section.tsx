...
const features = [
  ...
  },
  {
    ...
    description:
      "Graduate with Google Ads, Google Analytics, Hootsuite, and Meta certifications.",
  },
  {
    icon: BarChart3,
  ...
  },
  {
    ...
    description:
      "Apply innovative design thinking methodologies to solve real marketing problems.",
  },
  {
    icon: Globe,
